requirejs.config({
    ...
    shim: {
        'objectsKontrol/oscillatorAudio':['objectsKontrol/oscillator'],
        'objectsKontrol/sliderAudio':['objectsKontrol/slider'],
        'objectsKontrol/outAudio':['objectsKontrol/out'],
        'objectsKontrol/toggle':['objectsKontrol/canvas'],
        'objectsKontrol/objectsKontrol': ['objectsKontrol/oscillatorAudio', 'objectsKontrol/bang', 'objectsKontrol/draw', 'objectsKontrol/knob','objectsKontrol/sliderAudio', 'objectsKontrol/toggle','objectsKontrol/outAudio']
    }
});

// Start the main app logic.
requirejs(['objectsKontrol/objectsKontrol'],
    function () {
